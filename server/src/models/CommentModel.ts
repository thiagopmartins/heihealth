...
export interface CommentInstance extends Sequelize.Instance<CommentsAttributes> { };

export interface CommentModel extends BaseModelInterface, Sequelize.Model<CommentInstance, CommentsAttributes> { }
